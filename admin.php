...
<html lang="en">
  ...
  <!-- Jumbotron -->
      <div class=" jumbotron-fluid text-center"> 
        <div class="container"><div class="judul text-center mt-5" style="background-image: url('images/background/bg.jpg'); background-size: cover; background-position: center;">
          <h1 class="display-4"><span class="font-weight-bold">BUAI CAFE </span></h1>
          <hr>
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>Buai</strong> Cafe</a>
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">BUAI CAFE</h3>
          <h5>Jalan Sutan Syahrir, Mata Air, Padang Selatan
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          ...
          <a href="https://www.instagram.com/divaclinic_padang?igsh=MWdrdTIwYmtyMnljNw=="><img src="images/icon/ig.png" class="mr-3" data-toggle="tooltip" title="Instagram"></a>
