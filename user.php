...
<html lang="en">
  ...
  <!-- Jumbotron -->
      <div class=" jumbotron-fluid text-center"> 
        <div class="container">
        <div class="judul text-center mt-5" style="background-image: url('images/background/bg.jpg'); background-size: 500% 500% cover; background-position: center; height: 500%;">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>Buai</strong> Cafe</a>
