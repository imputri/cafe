    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="section-title">
                <h4 class="text-primary text-uppercase" style="letter-spacing: 5px;">Food & Drink </h4>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="aset/img/mieayam.jpg" alt="">
                        </div>
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="aset/img/ayambakar.jpg" alt="">
                        </div>
                        <div class="col-8 col-sm-9">
                            <h4>Ayam Bakar</h4>
                        </div>
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="aset/img/mieayambakso.jpg" alt="">
                        </div>
                        <div class="col-8 col-sm-9">
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="aset/img/nasgor.jpg" alt="">
                        </div>
                        <div class="col-8 col-sm-9">
                            <h4>Nasi Goreng</h4>
                            </div>
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="aset/img/lele.jpg" alt="">
                        </div>
                        <div class="col-8 col-sm-9">
                            <h4>Lele Bakar</h4>
                            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="aset/img/menu-1.jpg" alt="">
                        </div>
                        <div class="col-8 col-sm-9">
                            <h4>Black Coffee</h4>
                            </div>
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="aset/img/menu-2.jpg" alt="">
                        </div>
                        <div class="col-8 col-sm-9">
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="aset/img/menu-3.jpg" alt="">
                        </div>
                        <div class="col-8 col-sm-9">
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="aset/img/cortado.jpg" alt="">
                        </div>
                        <div class="col-8 col-sm-9">
                            <h4>Mochachino</h4>
                            </div>
