<?php 
include('koneksi.php'); // Make sure to include or require the file containing database connection details
session_start();
...
<div class="container">
    ...
    <table class="table table-bordered" id="example">
        ...
        <?php
        $nomor = 1;
        // Make sure $koneksi is not null and is a valid mysqli connection
        // If you haven't established connection yet, do it here
